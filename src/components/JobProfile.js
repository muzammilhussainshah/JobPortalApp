        ...
        return (
            ...
            <ScrollView >
                ...
                <View style={{ justifyContent: "space-between", alignItems: 'center', marginVertical: '2%', flexDirection: 'row' }}>
                    <Text style={{ fontSize: 18, color: '#fff', fontWeight: 'bold' }}> Create Profile </Text>
                ...
                <View style={styles.countryPickerView}>
                    <Picker
                        ...
                        onValueChange={(data) => {
                            ...
                            this.props.onChangeForAllFields("country", data)
                        }}
                    >
                        {
                    ...
                    <View style={styles.countryPickerView}>
                        <Picker
                            ...
                            onValueChange={(data) => {
                                ...
                                this.props.onChangeForAllFields("states", data)
                            }}
                        >
                    ...
                    <View style={styles.countryPickerView}>
                        <Picker
                            ...
                            onValueChange={(data) => {
                                ...
                                this.props.onChangeForAllFields("city", data)
                            }}
                        >
                            {
                ...
                <View style={{ flex: 1, paddingVertical: '1%', paddingHorizontal: '3%' }}>
                    <Text style={{ fontSize: 15, color: 'white' }}>
                        Type Job titles you are interested in
        </Text>
                    {this.props.intrestedTags.length !== 0 ?

                        <View>
                            {this.props.intrestedTags.map((item, index) => {
                                return (
                                    <View style={{
                                    ...
                                    >
                                        ...
                                        <Material
                                            onPress={() =>
                                                this.props.deleteTags(index, "intrested")
                                            }
                                            name="delete-outline" style={{ color: "white", fontSize: 22 }} />
                                    </View>
                                )
                            })}
                        </View> : null
                ...
                <View style={{ flex: 1, paddingVertical: '1%', paddingHorizontal: '3%' }}>
                    ...
                    {this.props.skillsTags.length !== 0 ?
                        <View>
                            {this.props.skillsTags.map((item, index) => {
                                return (
                                    <View style={{
                                        padding: 5, flexDirection: "row", justifyContent: "space-between"
                                    }}
                                    ...
                                    >
                                        ...
                                        <Material
                                            onPress={() =>
                                                this.props.deleteTags(index, "skills")
                                            }
                                            name="delete-outline" style={{ color: "white", fontSize: 22 }} />
                                    </View>
                                )
                    ...
                    <View style={{ flex: 2, flexDirection: 'row',paddingVertical: '1%', paddingHorizontal: '1.5%' }}>
                        ...
                        {/* <Button title="click" onPress={() => this.chooseFile()} /> */}
                ...
                <View style={{ flex: 1, marginVertical: '5%', paddingVertical: 10 }}>
                    ...
                    <Button block rounded style={{ backgroundColor: '#0054BC' }}
                        ...
                        <Text style={{ color: '#fff' }}> Attach your CV </Text>
                    </Button>
                </View>
